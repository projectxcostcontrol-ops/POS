...
export default function Login() {
  ...
  return (
    <div className="auth-page" style={{
      ...
      <form onSubmit={submit} className="card auth-card" style={{ width: 380 }}>
        <div className="auth-brand">
          <span className="brand-mark"><BowlSteam size={38} weight="light" /></span>
          <span><strong>ล้านครัว</strong><small>แอปจัดการร้านอาหารยุคใหม่</small></span>
        </div>
        <p className="auth-title">{mode === 'signin' ? 'ยินดีต้อนรับกลับ' : 'เริ่มต้นใช้งานล้านครัว'}</p>
